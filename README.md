...
支持通过 OpenAI-compatible 接口对原始内容进行整理和强化，自动生成标题、自测问题、答案、复习提示和易错点，让素材更适合记忆和回顾。
...
当前测试版本 **没有内置 AI API**，所以首次打开 App 时，AI 相关功能默认是不能直接使用的。
...
可以 **前往阿里百炼平台，领取新用户福利，免费获得模型用量，当前app适配qwen-turbo模型**。
跳转链接：[大模型服务平台百炼控制台](https://bailian.console.aliyun.com/cn-beijing/?tab=model#/api-key)
